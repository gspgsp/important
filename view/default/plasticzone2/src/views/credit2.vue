<template>
    ...
    <header id="bigCustomerHeader">
    	<a style="position: absolute;top: 10px;left: 10px;width: 30px;height: 30px;line-height: 30px; color: #ffffff;font-size: 13px;" href="http://q.myplas.com/">首页</a>
    	企业信用信息
    </header>
    ...
    <div class="creditwrap">
    	...
    	<p>
    		经“我的塑料网”塑料电商交易平台信用认证，贵司企业信用良好，为{{credit_level}}级，<span v-show="is_credit==='2'">预计</span>授信额度：<span>{{credit_limit}}万</span>元人民币，特发此证！
    	</p>
    </div>
