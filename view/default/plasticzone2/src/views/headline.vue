...
<ul class="plasticcredit2">
	<li><a href="javascript:;" v-on:click="defineshow"><i class="plasticIcon picon5"></i><br>产品定义</a></li>
	<li><a href="javascript:;" v-on:click="rateshow"><i class="plasticIcon picon6"></i><br>费率</a></li>
	<li><a href="javascript:;" v-on:click="sqshow"><i class="plasticIcon picon7"></i><br>我要申请</a></li>
</ul>
<footerbar></footerbar>
