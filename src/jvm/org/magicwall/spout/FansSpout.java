...
/**
 * 源源不断的从Redis中订阅购买信息
 * 信息输出：user_id:focus_id:(A|D|*):
 */
public class FansSpout extends BaseRichSpout {
    ...
    final int redisPort;
    final String queue = "suggestion_fans";
    LinkedBlockingQueue<String> tempQueue;   // 临时的本地队列
    JedisPool pool;

    public FansSpout(String redisHost, int redisPort) {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("fansspout"));
    }
}
