 ...
 * 源源不断的从Redis中订阅购买信息
 */
public class PurchaseSpout extends BaseRichSpout {
    ...
    final int redisPort;
    final String queue = "suggestion_purchase";
    LinkedBlockingQueue<String> tempQueue;   // 临时的本地队列
    JedisPool pool;

    public PurchaseSpout(String redisHost, int redisPort) {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("purchasespout"));
    }
}
