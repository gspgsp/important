...
class pdfAction extends adminBaseAction {
	...
	<tr align="left">
		<td width="440" height="20">供方（甲方）：上海中晨电子商务股份有限公司</td>
		<td height="20">合同编号：SH2016041404</td>
	</tr>
	<tr  align="left">
		<td  width="440" height="20">需方（乙方）：潍坊信步贸易有限公司</td>
		<td height="20">签约地点：上海 虹口</td>
	</tr>
	<tr  align="left">
		<td height="20"></td>
		<td height="20">签约时间：2016-04-14 10:20</td>
	</tr>
	<tr align="left">
...
<table width="635" align="left" bgcolor="#fff">
  ...
  <tr>
		<td></td>
		<td  height="20" style="line-height:20px;">提货日期：</td>
		<td></td>
	</tr>
  <tr>
		<td></td>
		<td  height="20" style="line-height:20px;">运输方式及运费：</td>
		<td width="440"  height="20" style="line-height:20px;">运输方式按照以下第__种。 1.乙方自提。2.甲方代办托运。3.甲方送货。</td>
	</tr>
</table>
<table width="635" align="left" bgcolor="#fff">
  <tr>
  ...
  <tr>
		...
		<td height="20" style="line-height:20px;"></td>
		<td width="505" height="20" style="line-height:20px;">2、验收方式：对于数量、包装有异议，乙方须在到货当日以书面形式向甲方提出。对于质量或其他有异议的，乙方须在到货之日起三日内，以书面形式向甲方提出。否则，视为验收合格。</td>
  </tr>
  <tr>
		<td height="20" style="line-height:20px;"></td>
		<td height="20" style="line-height:20px;"></td>
...
<table width="635" align="left" bgcolor="#fff">
  <tr>
		...
		<td width="505" height="20" style="line-height:20px;">银行电汇</td>
  </tr>
  <tr>
		<td height="20" style="line-height:20px;"></td>
		<td height="20" style="line-height:20px;">付款日期：</td>
		<td width="505" height="20" style="line-height:20px;">2016/7/13，款到提货</td>
  </tr>
</table>
<table width="635" align="left" bgcolor="#fff">
  <tr>
		...
		<td width="505" height="20" style="line-height:20px;">乙方付清全部货款前，无论货物是否交付，全部货物所有权归属甲方。乙方付清全部货款后，提货之日起货物所有权归属乙方，乙方付清全部货款后，提款之日起货物毁损灭失等风险由乙方承担。</td>
	</tr>
</table>
<table width="635" align="left" bgcolor="#fff">
  <tr>
  ...
  <tr>
		<td height="20" style="line-height:20px;"></td>
		<td height="20" style="line-height:20px;"></td>
		<td width="505" height="20" style="line-height:20px;">2、乙方逾期付款的，应向甲方支付违约金，违约金按照本合同总金额每日千分之八计算。因此产生的运输费、仓储费、诉讼费、保全费、律师费、差旅费、货物价格波动损失及其他损失由乙方承担。逾期付款超过三日的，甲方有权解除合同。</td>
	</tr>
  <tr>
		<td height="20" style="line-height:20px;"></td>
		<td height="20" style="line-height:20px;"></td>
...
<table width="635" align="left" bgcolor="#fff">
  <tr>
		...
		<td width="505" height="20" style="line-height:20px;">1、乙方付清全部货款后，甲方开始给乙方17%的增值税发票。</td>
	</tr>
  <tr>
		<td></td>
		<td></td>
	...
	%s
		...
		foreach($detiles as $k => $v){
			$detail_info .= '<tr >
				...
				<td bgcolor="#FFFFFF" align="center"  height="20" style="line-height:20px;">'.$v['model'].'</td>
				...
				<td bgcolor="#FFFFFF" align="center"  height="20" style="line-height:20px;">'.$v['number']*$v['unit_price'].'</td>
			</tr >';
		}
		...
		$table1='<tr>
				...
				<td width="60" bgcolor="#FFFFFF" align="center"  height="20" style="line-height:20px;">规格/型号</td>
				...
				<td width="92" bgcolor="#FFFFFF" align="center"  height="20" style="line-height:20px;">单价</td>
				<td width="100" bgcolor="#FFFFFF" align="center"  height="20" style="line-height:20px;">金额</td>
			</tr>
			' .$detail_info. '
			<tr>
				<td bgcolor="#FFFFFF"  height="20" style="line-height:20px;">合计</td>
				<td colspan="6" bgcolor="#FFFFFF" class="number"  height="20" style="line-height:20px;">'.$orderList['total_price'].'</td>
			</tr>
			<tr>
		...
		$table2='
			<tr>
				...
				<td align="left" height="20" style="line-height:20px;"  width="200">'.上海梓辰实业有限公司.'</td>
			...
			<tr>
				<td align="right" height="20" style="line-height:20px;" width="105">法人：</td>
				<td>'.李铁道.'</td>
				<td align="right" height="20" style="line-height:20px;" width="105">法人：</td>
				<td></td>
			</tr>
			<tr>
				<td align="right" height="20" style="line-height:20px;" width="105">经办人：</td>
				<td>'.$admname.'</td>
				<td align="right" height="20" style="line-height:20px;" width="105">经办人：</td>
				<td></td>
			</tr>
			<tr>
				<td align="right" height="20" style="line-height:20px;" width="105">传真：</td>
				<td>021-61673516</td>
				<td align="right" height="20" style="line-height:20px;" width="105">传真：</td>
				<td>020-98765432</td>
			</tr>
		...
		$str = sprintf($arr['pdf_template']['sale'],'上海梓辰实业有限公司',$orderList['order_sn'],$orderList['c_name'],$orderList['sign_place'],$sign_time,$table1,$location,$pickup_time,(L('transport_type')[$orderList['transport_type']]),(L('pay_method')[$orderList['pay_method']]),$payment_time,$orderLists['payment_way'],$table2);
