...
K.options = {
	...
	minWidth : 650,
	minHeight : 100,
	minChangeSize : 5,//'multiimage','flash', 'media', 'insertfile', 'code', 'baidumap',
	items : [
		...
		'italic', 'underline', 'strikethrough', 'lineheight', 'removeformat', '|', 'image','flash',
...
KEditor.prototype = {
	...
	create : function() {
		...
		container.removeClass('container')
			.addClass('ke-container ke-container-' + self.themeType).css('width','580px' );//width
		if (fullscreenMode) {
			container.css({
				position : 'absolute',
				left : 0,
