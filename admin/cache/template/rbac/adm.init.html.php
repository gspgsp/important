...
<div class="mini-fit" style="padding:1px 3px 3px;">
	<div id="gridCell" class="mini-datagrid" style="width:100%;height:100%;"
						url="/rbac/adm/init?action=grid<?php if ($this->_var['isPublic'] == '1'): ?>&isPublic=<?php echo $this->_var['isPublic']; ?><?php endif; ?>"  idField="admin_id" multiSelect="true" <?php if ($this->_var['doact'] != 'search' && $this->_var['isPublic'] != '1'): ?> allowCellEdit="true" allowCellSelect="true"<?php endif; ?>
						sizeList="[10,20,50,100]" pageSize="20" onrowdblclick="onRowDblClick">
		<div property="columns">
			<div type="checkcolumn"></div>
			<?php if ($this->_var['lock'] != 'lockadmin'): ?>
...
<?php if ($this->_var['doact'] == 'search' || $this->_var['isPublic'] == '0'): ?>
				...
				<table style="width:100%;">
					<input class="mini-hidden" name="admin_id"/>
						...
						<tr>
							...
							<td><input name="pid" class="mini-combobox"  data='<?php echo $this->_var['leader_json']; ?>' textField="name" valueField="id" style="width:100px;" required="true"/></td>
						</tr>
						<tr>
							<td>帐户状态：</td>
