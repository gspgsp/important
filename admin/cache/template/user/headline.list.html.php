...
<div id="open_member" class="mini-window" title="开通会员" style="width:800px; height:200px;" showModal="true" allowResize="true" allowDrag="true">
	<div id="replaceForm" class="form" >
		<table style="width:100%;">
			...
			<tr>
				<td width="80">开通类型</td>
				<td>
					<input name="cate_id" vtype="int" class="mini-checkboxlist" textField="textField" valueField="valueField" data='<?php echo json_encode($this->_var['cate']); ?>' required="true" />
				</td>
			</tr>
			<tr>
				<td>开通时间:</td>
				<td>
					<input name="year_num" width="80" class="mini-spinner"  minValue="1" maxValue="30"/>&ensp;/年
				</td>
			</tr>
			<tr>
				<td>会员经办人:</td>
	...
	<div id="delForm" class="form" >
		<table style="width:100%;">
			...
			<tr class="del_hidden" style="display:none;">
				<td>删除分类：</td>
				<td>
					<input name="cate_id" id="cate_id" vtype="int" class="mini-checkboxlist" textField="textField" valueField="valueField" data='<?php echo json_encode($this->_var['cate']); ?>' required="true" />
				</td>
			</tr>
			<tr height="15"></tr>			
			<tr>
...
function memberViewflow(userid){
	var width=1200, height=400,title="会员操作记录";
	mini.open({
