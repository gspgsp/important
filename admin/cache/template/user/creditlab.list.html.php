...
<div class="mini-fit" style="padding:1px 3px 3px;">
	<div id="gridCell" class="mini-datagrid" style="width:100%;height:100%;"url="/user/creditlab/init?action=grid&do=<?php echo $this->_var['doact']; ?>&ischecked=<?php echo $this->_var['ischecked']; ?>"  idField="id" 
	...
	<div id="addForm" class="form" >
		<table style="width:100%;">
			...
			<tr>
				<td>信用分类名称：</td>
				<td>
                   <input name="cat_id" class="mini-combobox" data='<?php echo setMiniConfig($this->_var['cat_name']); ?>' textField="name" valueField="id" style="width:120px;" required="true" onvaluechanged="catGrade(this.value)"/>          
			...
			<tr>
				<td>信用指标说明：</td>
				<td><input name="lab_desc" class="mini-textarea" style="width:200px" required="false"/ value="<?php echo $this->_var['data']['remark']; ?>">
				</td>
			</tr>			
			<tr>
				<td>备注</td>
				<td><input name="remark" class="mini-textarea" style="width:200px" required="false"/ value="<?php echo $this->_var['data']['remark']; ?>">
				</td>
			</tr>
			<tr>
