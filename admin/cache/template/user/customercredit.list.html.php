...
?>
					<option value="lab_id<?php echo $this->_var['value2']['lab_id']; ?>"><?php echo $this->_var['value2']['lab_name']; ?></option>
...
<div class="mini-fit" style="padding:1px 3px 3px;">
	<div id="gridCell" class="mini-datagrid" style="width:100%;height:100%;"url="/user/customercredit/init?action=grid&do=<?php echo $this->_var['doact']; ?>&ischecked=<?php echo $this->_var['ischecked']; ?>"  idField="id" 
...
?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="number" name="field<?php echo $this->_var['value2']['lab_id']; ?>" min="0" max="<?php echo $this->_var['value2']['lab_grade']; ?>" step="0.5" value="" style="width:50px" required="true" autocomplete='on' onfocus=this.select() onblur="inputSum(this.value)">【<?php echo $this->_var['value2']['lab_grade']; ?>分】&nbsp; 说明：<?php echo $this->_var['value2']['lab_desc']; ?>
                    </td>                    
                </tr>
                  <?php endif; ?>   	
          <?php endforeach; endif; unset($_from); ?><?php $this->_pop_vars();; ?>
