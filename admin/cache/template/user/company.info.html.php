	...
	<div id="infoForm" class="form">
		<div class="mini-tabs" activeIndex="0" plain="false">
			<div title="基本信息">
				...
				<input class="mini-hidden" name="c_id" value="<?php echo $this->_var['user']['c_id']; ?>"/>
				<input class="mini-hidden" name="info_user_id" value="<?php echo $this->_var['info_ext']['user_id']; ?>"/>
				<table width="100%">
					<caption><strong>基本信息</strong></caption>
					<tr>
						<td>客户名称：</td>
						<td>
							<input name="c_name" class="mini-textbox" style="width:250px;" maxlength="50" required="true" value="<?php echo $this->_var['user']['c_name']; ?>"/>
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr>
						<td>所需牌号：</td>
						<td><input name="need_product" class="mini-textbox" style="width:250px;" required="true" value="<?php echo $this->_var['user']['need_product']; ?>"/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>所在省市</td>
						<td><input name="company_province" id="place_1_0" style="width:80px;" class="mini-combobox" textField="name" valueField="id" onvaluechanged="setReg('place')" data='<?php echo setMiniConfig($this->_var['regionList']); ?>' value="<?php echo $this->_var['user']['company_province']; ?>" showNullItem="true"/>
							<input name="company_city" id="place_2_0" url="<?php if ($this->_var['user']['company_province'] != ''): ?>/user/user/getRegion?pid=<?php echo $this->_var['user']['company_province']; ?><?php endif; ?>" value="<?php echo $this->_var['user']['company_city']; ?>" class="mini-combobox" style="width:80px;" textField="name" valueField="id" />            </td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
			 <!--    <tr>
						<td>邮政编码：</td>
						<td>
							<input name="zip" class="mini-textbox" value="<?php echo $this->_var['user']['zip']; ?>" style="width:100px;" maxlength="6"  vtype="zip"/>
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr> -->
					...
					<tr>
						<td>注册资本：</td>
						<td>
							<input name="registered_capital" class="mini-textbox" style="width:100px;" required="true" onvalidation="onValidFullMoney" value="<?php echo empty($this->_var['user']['registered_capital']) ? '' : $this->_var['user']['registered_capital']; ?>"/>
						万元
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<tr>
						<td>实到资本：</td>
						<td>
							<input name="true_capital" class="mini-textbox" style="width:100px;" required="true" onvalidation="onValidFullMoney" value="<?php echo empty($this->_var['user']['true_capital']) ? '' : $this->_var['user']['true_capital']; ?>"/>
							万元
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<?php if ($this->_var['see1']): ?>
					<tr>
						<td>预信用额度：</td>
						<td>
							<input name="pre_credit_limit" class="mini-textbox" style="width:100px;" required="true" onvalidation="onValidFullMoney" value="<?php echo empty($this->_var['user']['credit_limit']) ? '' : $this->_var['user']['credit_limit']; ?>"/>
							万元
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<tr>
						<td>信用额度：</td>
						<td>
							<input name="credit_limit" class="mini-textbox" style="width:100px;" required="true" onvalidation="onValidFullMoney" value="<?php echo empty($this->_var['user']['credit_limit']) ? '' : $this->_var['user']['credit_limit']; ?>"/>
							万元
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
				...
				<table>
					...
					<?php if ($this->_var['see']): ?>
					<tr>
						<td>客户类型：</td>
						<td><input name="type" class="mini-combobox" style="width:150px;" required="true" value="<?php echo $this->_var['user']['type']; ?>" data='<?php echo setMiniConfig($this->_var['type']); ?>'  textfield="name" valuefield="id"/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<?php endif; ?>
				<!--   <tr>
					...
					<tr class="three hidden">
						<td>营业执照号：</td>
						<td><input class="mini-textbox" style="width:250px;" name="business_licence" value="<?php echo $this->_var['user']['business_licence']; ?>"/>
						</td>
						<td>执照照片：</td>
						<td>
					...
					<tr class="three hidden">
						<td>组织代码：</td>
						<td><input class="mini-textbox" style="width:250px;" name="organization_code" value="<?php echo $this->_var['user']['organization_code']; ?>"/>
						</td>
						<td>组织图片：</td>
						<td>
					...
					<tr class="three hidden">
						<td>税务登记码：</td>
						<td><input class="mini-textbox" style="width:250px;" name="tax_registration" value="<?php echo $this->_var['user']['tax_registration']; ?>"/>
						</td>
						<td>税务图片：</td>
						<td>
					...
					<tr>
						<td>信用等级：</td>
						<td><input class="mini-combobox" name="credit_level" data='<?php echo setMiniConfig($this->_var['credit_level']); ?>' textfield="name" valuefield="id" value="<?php echo $this->_var['user']['credit_level']; ?>"/>
						</td>
						<td>附件地址：</td>
						<td>
					...
					<tr>
						<td>是否授信：</td>
						<td><input class="mini-combobox" name="is_credit" style="width:100px;" data='<?php echo setMiniConfig($this->_var['credit']); ?>' required="true" textfield="name" valuefield="id" value="<?php echo empty($this->_var['user']['is_credit']) ? '0' : $this->_var['user']['is_credit']; ?>"/></td>
					</tr>
					<tr>
						<td>状态：</td>
			...
			<div title="联系人基本信息">
				<div style="height:385px">
					<table border="0" cellpadding="1" cellspacing="2">
								<tr>
									<td >姓名：</td>
									<td><input name="info_name" class="mini-textbox" style="width:150px;" required="true" vtype="rangeLength:2,30" value="<?php echo $this->_var['info_ext']['name']; ?>" /></td>
									<td>性别：</td>
									<td><input class="mini-combobox" name="info_sex" style="width:100px;" data='<?php echo setMiniConfig($this->_var['sex']); ?>' required="true" textField="name" valueField="id" value="<?php echo $this->_var['info_ext']['sex']; ?>"/></td>
								</tr>
								<tr>
									<td style="width:80px;">手机：</td>
									<td style="width:210px;"><input name="info_mobile" class="mini-textbox" maxlength="11" value="<?php echo $this->_var['info_ext']['mobile']; ?>" style="width:150px;" required="true" onvalidation="onValidMobile"/></td>
									<td>电话：</td>
									<td><input name="info_tel" class="mini-textbox" style="width:150px;"  value="<?php echo $this->_var['info_ext']['tel']; ?>" vtype="rangeLength:6,14"/></td>
								</tr>
								<tr>
									<td style="width:80px;">QQ号：</td>
									<td style="width:210px;"><input name="info_qq" class="mini-textbox" maxlength="12" value="<?php echo $this->_var['info_ext']['qq']; ?>" style="width:150px;"/></td>
									<td>传真：</td>
									<td><input name="info_fax" class="mini-textbox" style="width:150px;" value="<?php echo $this->_var['info_ext']['fax']; ?>"  vtype="rangeLength:6,14"/></td>
								</tr>
								<tr>
									<td>邮件：</td>
									<td><input name="info_email" class="mini-textbox" style="width:150px;"  value="<?php echo $this->_var['info_ext']['email']; ?>" vtype="email"/></td>
									<td></td>
									<td></td>
								</tr>
								<tr>
									<td>备注：</td>
									<td colspan="3">
										<input name="info_remark" class="mini-textarea" value="<?php echo $this->_var['info_ext']['remark']; ?>" style="width:403px; height:50px;"/>
									</td>
								</tr>
								<tr>
									<td>状态：</td>
									<td><input class="mini-combobox" name="info_status" style="width:100px;" data='<?php echo setMiniConfig($this->_var['status']); ?>' required="true" textField="name" valueField="id" value="<?php echo $this->_var['info_ext']['status']; ?>"/></td>
								</tr>
							</table>
				</div>
			</div>
