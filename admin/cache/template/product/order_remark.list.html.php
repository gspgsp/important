...
<div class="mini-fit" style="padding:1px 3px 3px;">
	<div id="gridCell" class="mini-datagrid" style="width:100%;height:100%;" url="/product/order/init?action=grid&do=<?php echo $this->_var['doact']; ?>&type=<?php echo $this->_var['order_type']; ?>"  idField="id"
