...
<div id="head">
  ...
  <div class="menu"> <span>您好，<strong><span style="font-size:14px;"><?php echo $_SESSION['name']; ?></span></strong> <a onclick="location.href='/index/pass/logout';">[退出]</a></span>
    <a href="__URL__" class="btn home" target="_blank">返回首页</a>
  	<a href="/wk" class="btn" target="_blank">报价平台</a>
...
?>
      <div id="menu_<?php echo $this->_var['k']; ?>" class="menus">
        <?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->_push_vars('cname', 'menu_0_41251000_1489722954');if (count($_from)):
    foreach ($_from AS $this->_var['cname'] => $this->_var['menu_0_41251000_1489722954']):
?>
        <h3><span></span><?php echo $this->_var['cname']; ?></h3>
        <ul>
          <?php $_from = $this->_var['menu_0_41251000_1489722954']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->_push_vars('', 'subList');if (count($_from)):
...
?>
    ...
    <div id="copyright">
      <p>Powered by <a target="_blank" href="http://www.wodesuliao.cn">wodesuliao.cn</a></p>
      <p>&copy; 2006-2016</p>
    </div>
