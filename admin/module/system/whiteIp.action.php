 ...
 * IP白名单
 */
class whiteIpAction extends adminBaseAction {
	public function __init(){
		$this->debug = false;
		$this->action = sget('action','');
		$this->db=M('public:common')->model('white_ip');
	}
	...
	public function init(){
		...
		$this->assign('page_title','IP白名单');
		$this->display('white_ip.html');
	}
