...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__creditIntro_vue__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__creditIntro_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__creditIntro_vue__);



new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#app',
  template: '<CreditIntro/>',
  components: { CreditIntro: __WEBPACK_IMPORTED_MODULE_1__creditIntro_vue___default.a }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('Leftmodel'), _vm._v(" "), _c('MiddleView'), _vm._v(" "), _vm._m(0)], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "credit2 w96"
  }, [_c('h3', [_vm._v("授信说明")]), _vm._v(" "), _c('p', [_vm._v("本授信是[我的塑料网]针对网站的优质客户，提供的供应链金融业务授信，客户可以在授信额度范围内使用[我的塑料网]提供的供应链金融产品，满足企业的融资需求。")]), _vm._v(" "), _c('h3', [_vm._v("特点:")]), _vm._v(" "), _c('p', [_vm._v("1.以便捷、高效的整体合作模式，使客户迅速得到全面和规范的供应链金融服务；")]), _vm._v(" "), _c('p', [_vm._v("2.节省客户的用款成本，简化工作手续，提高融资效率；")]), _vm._v(" "), _c('p', [_vm._v("3.基于真实订单需求，在整体信用额度的前提下，随借随用，即时到账；")]), _vm._v(" "), _c('p', [_vm._v("4.低利息、低费用。")]), _vm._v(" "), _c('h3', [_vm._v("适用客户:")]), _vm._v(" "), _c('p', [_vm._v("企业信用良好、与[我的塑料网]订单成交三笔以上以及其他必要条件。")]), _vm._v(" "), _c('h3', [_vm._v("注：授信解释权归[我的塑料网]所有。")])])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-7367da95", module.exports)
  }
}
...
Component.options.__file = "E:\\xampp\\htdocs\\bendi\\branches\\www\\view\\default\\mypczone\\src\\views\\creditIntro\\creditIntro.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7367da95", Component.options)
  } else {
    hotAPI.reload("data-v-7367da95", Component.options)
  }
})()}
