...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chother_vue__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chother_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__chother_vue__);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#app',
  template: '<Chother/>',
  components: { Chother: __WEBPACK_IMPORTED_MODULE_1__chother_vue___default.a }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "back"
  }, [_vm._v("查别人")]), _vm._v(" "), _c('div', {
    staticClass: "credit3 w96"
  }, [_c('img', {
    attrs: {
      "src": "http://pic.myplas.com/mypc/img/discovery4.png",
      "width": "245",
      "height": "253"
    }
  }), _vm._v(" "), _c('h3', [_vm._v("精准查询")]), _vm._v(" "), _c('p', [_vm._v("企业名称查询")]), _vm._v(" "), _c('p', [_vm._v("自动关联企业相关数据")]), _vm._v(" "), _c('div', {
    staticClass: "search"
  }, [_c('form', {
    attrs: {
      "name": "",
    ...
    return _c('li', [_c('a', {
      ...
      on: {
        "click": function($event) {
          _vm.getInfo(c.contact_id)
        }
      }
    }, [_vm._v(_vm._s(c.c_name))])])
  }))])])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-33459845", module.exports)
  }
}
...
Component.options.__file = "E:\\xampp\\htdocs\\bendi\\branches\\www\\view\\default\\mypczone\\src\\views\\chother\\chother.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] chother.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-33459845", Component.options)
  } else {
    hotAPI.reload("data-v-33459845", Component.options)
  }
})()}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getInfo: function getInfo(contact_id) {
