...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__myHelp_vue__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__myHelp_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__myHelp_vue__);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#myHelp',
  template: '<myHelp/>',
  components: { myHelp: __WEBPACK_IMPORTED_MODULE_1__myHelp_vue___default.a }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    attrs: {
      "src": "http://pic.myplas.com/mypc/img/my1.png",
      "width": "520",
      "height": "2464"
    }
  })])])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-8fef4ee6", module.exports)
  }
}
...
Component.options.__file = "E:\\xampp\\htdocs\\bendi\\branches\\www\\view\\default\\mypczone\\src\\views\\myHelp\\myHelp.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] myHelp.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8fef4ee6", Component.options)
  } else {
    hotAPI.reload("data-v-8fef4ee6", Component.options)
  }
})()}
