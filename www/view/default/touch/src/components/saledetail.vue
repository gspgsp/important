<template>
   ...
   <h3 class="buyTitle">
    ...
    <div class="buyDetail2">
    	<p><img src="../../img/buydetail2.png"><span>交易员:{{con_name}}{{mobile}}</span></p>
    ...
    <footer id="footer">
        ...
        <ul>
            ...
            <li><a v-link="{name:'sale'}" class="footerOn"><i class="foot2"></i><br>我要卖货</a></li>
	...
	module.exports={
        ...
        ready:function () {
        	...
        	this.$http.post('/mobi/mainPage/getCheckDelegate',{otype:1,id:this.$route.query.id}).then(function(res){
        		...
        		this.$set('con_name',res.json().chDeRes.cus_manager);
        		...
        		this.$set('mobile',res.json().chDeRes.cus_mobile);
